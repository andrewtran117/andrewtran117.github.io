const WorkExperience = () => {
    return (
        <div className = "pb-10">
        <h2 className="text-2xl text-[#D1D1D1] pb-1 pt-10">Software Engineering Experience</h2>
        
        <div className="pt-4 text-[#D1D1D1]">
            <h3> Demonstrated expertise in software engineering, project management, and technical problem-solving. </h3>
        </div>
        ...
        <div className="text-[#f9f9f9]">
          ...
          {/* <div className="pt-4">
            <h3 className="font-semibold">Undergraduate Researcher, Generative AI</h3>
            <p className="text-sm">National Science Foundation (NSF) </p>
