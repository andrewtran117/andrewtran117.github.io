...
export default function Greetings(){
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 w-full max-w-6xl px-4 animate-fadeInSmooth transform">
            ...
            <div className="flex items-center justify-center" style={{ transform: 'translateX(8%)' }}>
                <img
                    src="/matcha2.png"
                    alt="Matcha Glass"
